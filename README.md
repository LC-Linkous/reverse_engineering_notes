...
graph LR;
    ...
    B2 --> B2a2["**Tool Examples:**<br>• Multimeter<br>• Oscilloscope<br>• Logic Analyzer"]
    B3 --> B3a1["**Task Examples:**<br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE"]
    B3 --> B3a2["**Tool Examples:**<br>• Microscope<br>• Thermal Camera<br>• UV Light"]
    B4 --> B4a1["**Task Examples:**<br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE"]
    B4 --> B4a2["**Tool Examples:**<br>• KiCad<br>• Altium Viewer<br>• PCB Photos"]
    B5 --> B5a1["**Task Examples:**<br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE"]
    B5 --> B5a2["**Tool Examples:**<br>• Logic Analyzer<br>• Oscilloscope<br>• Function Generator"]
    B6 --> B6a1["**Task Examples:**<br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE"]
    B6 --> B6a2["**Tool Examples:**<br>• Power Supply<br>• Current Meter<br>• EXAMPLE"]
    B7 --> B7a1["**Task Examples:**<br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE"]
    B7 --> B7a2["**Tool Examples:**<br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE"]
    B8 --> B8a1["**Task Examples:**<br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE"]
    B8 --> B8a2["**Tool Examples:**<br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE"]
