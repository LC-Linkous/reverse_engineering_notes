...
graph LR;
    ...
    click B "reverse_engineering_notes#hardware-analysis"
    click B1 "#physical-device-access"
    click B2 "#circuit-analysis"
    click B3 "#component-id"
    click B4 "#pcb-layout"
    click B5 "#signal-analysis"
    click B6 "#power-analysis"
    click B7 "#side-channel-analysis"
    click B8 "#fault-injection"
    ...
    click C3 "#embedded"
    click C4 "#mobile"
    click C5 "#web-applications"
    click C6 "#malware-analysis"
    ...
    click D3 "#rfidnfc"
    click D4 "#sub-ghzism"
    click D5 "#cellularmobile"
    click D6 "#iot-protocols"

    click E "#network-analysis"
    click E1 "#protocol-analysis"
    click E2 "#packet-capture"
    click E3 "#network-security"
    click E4 "#industrialiot-protocols"
    click E5 "#network-infrastructure"
    click E6 "#network-forensics"
