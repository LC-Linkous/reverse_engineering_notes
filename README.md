...
graph LR;
    ...
    B2 --> B2a1["<div style='text-align: left'><b>Task Examples:</b><br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE</div>"]
    B2 --> B2a2["<div style='text-align: left'><b>Tool Examples:</b><br>• Multimeter<br>• Oscilloscope<br>• Logic Analyzer</div>"]
    B3 --> B3a1["<div style='text-align: left'><b>Task Examples:</b><br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE</div>"]
    B3 --> B3a2["<div style='text-align: left'><b>Tool Examples:</b><br>• Microscope<br>• Thermal Camera<br>• UV Light</div>"]
    B4 --> B4a1["<div style='text-align: left'><b>Task Examples:</b><br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE</div>"]
    B4 --> B4a2["<div style='text-align: left'><b>Tool Examples:</b><br>• KiCad<br>• Altium Viewer<br>• PCB Photos</div>"]
    B5 --> B5a1["<div style='text-align: left'><b>Task Examples:</b><br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE</div>"]
    B5 --> B5a2["<div style='text-align: left'><b>Tool Examples:</b><br>• Logic Analyzer<br>• Oscilloscope<br>• Function Generator</div>"]
    B6 --> B6a1["<div style='text-align: left'><b>Task Examples:</b><br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE</div>"]
    B6 --> B6a2["<div style='text-align: left'><b>Tool Examples:</b><br>• Power Supply<br>• Current Meter<br>• EXAMPLE</div>"]
    B7 --> B7a1["<div style='text-align: left'><b>Task Examples:</b><br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE</div>"]
    B7 --> B7a2["<div style='text-align: left'><b>Tool Examples:</b><br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE</div>"]
    B8 --> B8a1["<div style='text-align: left'><b>Task Examples:</b><br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE</div>"]
    B8 --> B8a2["<div style='text-align: left'><b>Tool Examples:</b><br>• EXAMPLE<br>• EXAMPLE<br>• EXAMPLE</div>"]
